...
## Releases
- 2023-12-01 15:12 0.2.7 Setup nginx access.log rotation, sync crontab on deploy
- 2023-11-28 19:57 0.2.6 Fix infinite API request loop bug introduced in 0.2.2
